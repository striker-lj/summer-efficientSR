...
from .arch_util import to_2tuple, trunc_normal_, ResidualBlockNoBN, make_layer
...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self,
        ...
        self.sr_body = make_layer(ResidualBlockNoBN, num_block, num_feat=self.num_feat)
...
class SynSwinIR_sr(nn.Module):
    ...
    def __init__(self,
                 ...
                 SE_reduction=6,
                 **kwargs):
        super(SynSwinIR_sr, self).__init__()
        num_in_ch = in_chans
        num_out_ch = in_chans
        num_feat = 64
